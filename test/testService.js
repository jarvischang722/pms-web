...
// let dgSvc = require("../services/DatagridService");
let _ = require("underscore");
// let dbSVC = require("../services/DbTableService");
let operSvc = require("../services/operationService");
...
operSvc.fetchDgFieldData(lo_postData, session, function(err, result){
