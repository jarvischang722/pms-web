...
var _44=$.data(e.data.target,"dragable");
var _45=_44.options;
...
var _4a=$.data(e.data.target,"dragable");
_39(e);
...
_49(e);
var _4f=$.data(e.data.target,"dragable");
var _50=_4f.proxy;
var _51=_4f.options;
if(_51.revert){
if(_52()==true){
...
$.fn.dragable=function(_57,_58){
if(typeof _57=="string"){
return $.fn.dragable.methods[_57](this,_58);
}
return this.each(function(){
var _59;
var _5a=$.data(this,"dragable");
if(_5a){
_5a.handle.unbind(".dragable");
_59=$.extend(_5a.options,_57);
}else{
_59=$.extend({},$.fn.dragable.defaults,$.fn.dragable.parseOptions(this),_57||{});
}
var _5b=_59.handle?(typeof _59.handle=="string"?$(_59.handle,this):_59.handle):$(this);
$.data(this,"dragable",{options:_59,handle:_5b});
if(_59.disabled){
$(this).css("cursor","");
return;
}
_5b.unbind(".dragable").bind("mousemove.dragable",{target:this},function(e){
if($.fn.dragable.isDragging){
return;
}
var _5c=$.data(e.data.target,"dragable").options;
if(_5d(e)){
...
$.extend(e.data,_60);
var _61=$.data(e.data.target,"dragable").options;
if(_61.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.dragable",e.data,_43);
$(document).bind("mousemove.dragable",e.data,_49);
$(document).bind("mouseup.dragable",e.data,_4d);
...
function _5d(e){
var _62=$.data(e.data.target,"dragable");
var _63=_62.handle;
var _64=$(_63).offset();
...
$.fn.dragable.parseOptions=function(_67){
var t=$(_67);
...
_f1.disabledNodes=[];
_f2.dnd=true;
_f3.find("div.tree-node").dragable({disabled:false,revert:true,cursor:"pointer",proxy:function(_f4){
...
var icon=$(_105).dragable("proxy").find("span.tree-dnd-icon");
...
_293.window.dragable({handle:">div.panel-header>div.panel-title",disabled:_293.options.dragable==false,onBeforeDrag:function(e){
if(_293.mask){
...
return $.extend({},$.fn.panel.parseOptions(_2a1),$.parser.parseOptions(_2a1,[{dragable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,dragable:true,resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2a2(_2a3){
...
_bcd.find("a.slider-handle").dragable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
