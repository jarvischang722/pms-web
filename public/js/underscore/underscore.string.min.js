/* underscore.string 3.2.2 | MIT licensed | http://epeli.github.com/underscore.string/ */ ! function(e) {
    ...
    return function e(r, t, n) {
        ...
        7: [function(e, r) {
            var t = e("./helper/makeString"),
                n = "ąàáäâãåæăćčĉęèéëêĝĥìíïîĵłľńňòóöőôõðøśșšŝťțŭùúüűûñÿýçżźž",
                i = "aaaaaaaaaccceeeeeghiiiijllnnoooooooossssttuuuuuunyyczzz";
        ...
        45: [function(e, r) {
            var t = (e("./helper/makeString"), e("./helper/defaultToWhiteSpace"), e("./trim")),
                n = e("./dasherize"),
                i = e("./cleanDiacritics");
            r.exports = function(e) {
                            ...
                            if (g = e(t[o]), "string" === g) m.push(t[o]);
                                ...
                                if (c = t[o], c[2])
                                    for (a = n[f], u = 0; u < c[2].length; u++) {
                                        if (!a.hasOwnProperty(c[2][u])) throw new Error(i('[_.sprintf] property "%s" does not exist', c[2][u]));
                                        a = a[c[2][u]]
                                    } else a = c[1] ? n[c[1]] : n[f++];
                                if (/[^s]/.test(c[8]) && "number" != e(a)) throw new Error(i("[_.sprintf] expecting number but found %s", e(a)));
                                switch (c[8]) {
                                    case "b":
                                        a = a.toString(2);
                                        break;
                            ...
                            if (null !== (t = /^[^\x25]+/.exec(r))) n.push(t[0]);
                                ...
                                if (t[2]) {
                                    ...
                                    for (a.push(u[1]);
                                        ...
                                        if (null !== (u = /^\.([a-z_][a-z_\d]*)/i.exec(o))) a.push(u[1]);
                                        else {
        ...
        69: [function(e, r) {
            makeString = e("./helper/makeString"), r.exports = function(e, r) {
                if (e = makeString(e), r = r || {}, width = r.width || 75, seperator = r.seperator || "\n", cut = r.cut || !1, preserveSpaces = r.preserveSpaces || !1, trailingSpaces = r.trailingSpaces || !1, 0 >= width) return e;
                if (cut) {
                    for (index = 0, result = ""; index < e.length;) index % width == 0 && index > 0 && (result += seperator), result += e.charAt(index), index++;
                    if (trailingSpaces)
                ...
                for (words = e.split(" "), result = "", current_column = 0; words.length > 0;) {
                    if (1 + words[0].length + current_column > width && current_column > 0) {
                        if (preserveSpaces) result += " ", current_column++;
                            ...
                            for (; width > current_column;) result += " ", current_column++;
